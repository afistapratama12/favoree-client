...
export const listTestimoni = [{
    title : 'Sangat Merekomendasikan Platform ini',
    name: 'Ismail Habibi',
    text: `"Jasa Convert dari Favoree.id sangat membantu masalah saya yang ingin pindah saldo e-wallet dengan cepat. Saya sangat merekomendasikan platform ini"`
},{
    title : 'Sangat Puas',
    name: 'Rakryan',
